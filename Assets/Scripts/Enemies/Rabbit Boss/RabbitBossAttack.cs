...
public class RabbitBossAttack : MonoBehaviour
{
    RabbitBossAnimation rabbitBossAnimation;
    ...
    void Start()
    {
        ...
        rabbitBossAnimation = GetComponent<RabbitBossAnimation>();
    ...
    IEnumerator AttackLoop()
    {
        ...
        rabbitBossAnimation.DoAttackAnimation();
